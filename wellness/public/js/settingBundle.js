...
// Add methods to `SetCache`.
            ...
            [
                ...
                function ($scope, modelParam, settingSaveService, $modalInstance) {
                    ...
                    self.saveAnnouncementData = function (postParam) {
                        ...
                        settingSaveService.saveSettingData(modelParam.groupId, postParam, 'saveannouncements').then(function () {
                            $modalInstance.close();
                        });
                    };
        ...
        "../settings/export/exportController": 14,
        "../settings/group/groupCreateController": 20,
        "../shared/groupSearch/groupSearchController": 28,
        "../shared/removeHTMLTags": 32,
        "../utils/interceptor.js": 39,
        "./breadCrumb/breadCrumbController": 12,
        "./group/groupController": 19
            ...
            [
                ...
                function ($scope, settingService, modelParam, $modalInstance, lookupService) {
                    ...
                    self.getSettingData = function () {
                        ...
                        settingService.editSetting(modelParam.group.settingName, modelParam.group.groupId).then(function (response) {
        ...
        module.exports = angular.module(
            ...
            [
                ...
                function ($scope, $http, settingService, $location, primaryModal, settingSaveService, lookupService, $state) {
                    ...
                    self.constructSettingGrid = function (data, settingName) {
                        ...
                        var settings = {
                            ...
                            Announcements: function () {
                                self.settingsAnnouncementData = data.data;
                            },
                            ...
                            IntroScreen: function () {
                                self.introScreenData = data.data;
                            },
                            MarketingTiles: function () {
                                self.marketingTileData = data.data;
                            },
                            MyCompany: function () {
                                self.myCompanyData = data.data;
                            },
                            Incentives: function () {
                            ...
                            Programs: function () {
                                self.programsGrid.data = data.data;
                            },
                            SettingNameValueCollection: function () {
                                self.settingsGrid.data = data.data;
                            }
                        };
                        return settings[settingName]();
                    };
                    ...
                    /*Programs */
                    self.createAddProgramScreen = function (program) {

                        var primaryModalParam = {
                            template: 'partials/settings/addProgram.html',
                            controller: 'MyCompanyController as myCompanyCtrl',

                            modelParam: self.modelParam('AddProgram', program, 1, true),
                            size: 'lg'
                        };
                        primaryModal.launchPrimaryModal(primaryModalParam);
                    };
                    ...
                    self.filterCurrentSettings = function (showCurrentSetting, settingName) {
                        var settings = {
                            ...
                            Programs: function () {
                                self.myPrograms = self.customFilter(showCurrentSetting, self.myPrograms)
                            }
                        };
                        return settings[settingName]();
                    };
        ...
        "../../shared/lookupService": 30,
        "../../shared/primaryModal": 31,
        "../announcements/announcementController": 9,
        "../authenticationFields/authenticationFieldController": 11,
        "../introScreens/introScreenController": 22,
        "../marketingTiles/marketingTileController": 23,
        "../myCompany/myCompanyController": 24,
        "../pointsMatrix/pointsMatrixController": 25,
        "../services/settingSaveService": 26,
        "./settingHistoryController": 16,
        "./settingService": 18,
        "./addProgramController": 41
                ...
                function (restfulRepo) {
                    return {
                        ...
                        getSettingData: function (settingName) {
                            ...
                            if (settingName === 'Programs') {
                                return restfulRepo.getProgramMethod();
                            }
                ...
                function ($scope, groupService, settingService, $location, lookupService, $timeout) {
                    ...
                    if (sss === '/setting/recommendations') {
                        var recommendations = {
                            ...
                            "MenuIdentifier": "Recommendations",
        ...
        "../../shared/fileImport": 27,
        "../../shared/groupSearch/groupService": 29,
        "../../shared/lookupService": 30,
        "../groupSetting/settingService": 18
            ...
            [
                ...
                function ($scope, modelParam, settingSaveService, $modalInstance) {
                    ...
                    self.saveIntroScreenData = function (postParam) {
                        ...
                        settingSaveService.saveSettingData(modelParam.groupId, postParam, 'saveintroscreens').then(function () {
                            $modalInstance.close();
                        });
                    };
            ...
            [
                ...
                function ($scope, modelParam, settingSaveService, $modalInstance) {
                    ...
                    self.saveMarketingTileData = function (postParam) {
                        ...
                        settingSaveService.saveSettingData(modelParam.groupId, postParam, 'savemarketingtiles').then(function () {
                            $modalInstance.close();
                        });
                    };
        ...
        module.exports = angular.module(
            ...
            [
                '$scope', 'modelParam', 'settingSaveService', '$modalInstance', 'restfulRepo',
                function ($scope, modelParam, settingSaveService, $modalInstance, restfulRepo) {
                    var self = this;
                    self.myCompanyModel = [];
                    self.languageIndex = 0;
                    self.languageId = 1033;
                    self.glyphiconDisplayTextClass = [];
                    self.programParamArray = [];
                    ...
                    self.initialization = function () {
                        ...
                        self.nextTab = function (tab) {
                            $('.nav-tabs a[href="#program' + tab + '"]').tab('show');
                        };

                        self.header = modelParam.header;
                        self.programParam = modelParam.modelData;
                        self.languageList = modelParam.languageList;
                        self.myCompanyModel = modelParam.modelData;
                        self.programParamArray.push(modelParam.modelData);
                        restfulRepo.getProgramModalMethod()
                            .then(function (data) {
                                $scope.programProp = data.data;
                            });
                    };
    ...
    }, {"../services/settingSaveService": 26, "../../shared/restfulRepo": 33}], 25: [function (require, module, exports) {
                ...
                function ($scope, groupService) {
                    ...
                    self.getGridData = function () {
                        if (self.isDeepSearch) {
                            groupService.groupSearch($scope.group.groupId, $scope.search, self.pageCount).then(function (data) {
                                self.gridOptions.data = data.data.Groups;
                                self.totalPageCount = data.data.totalCount;
                            });
                        }
        ...
        "../../settings/groupSetting/settingListController": 17,
        "../../userCreationTool/creationController.js": 34,
        "../../userCreationTool/testUsersController.js": 37,
        "./groupService": 29
...
//                    return restfulRepo.getMethod(apiEndPoint);
        ...
        module.exports = angular.module(
            ...
            self.getProgramMethod = function (apiEndPoint) {
                return $http.get('ProgramGrid.json');
            }

            self.getProgramModalMethod = function (apiEndPoint) {
                return $http.get('ProgramModal.json');
            }
        ...
        'use strict';
        module.exports = angular.module(
            'onlife.admin.settings.addProgramController',
            [
                require('../../shared/restfulRepo').name
            ]
        ).service('addProgramController',
            [
                'restfulRepo',
                function (restfulRepo) {
                    return {
